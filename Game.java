...
Example: cell 4 is the second from the top and furthest to the left, it is represented by the coordinates, (0, 1)
				...
				This is for me later. I don't know where exactly to put this since 
*/
public class Game {
	...
	@SuppressWarnings("deprecation")
	public static void game(String[] Options) // where all the actions happens
	{
		...
		help.addActionListener(new ActionListener() // Lets pretend this doesn't exist for now
		{
			@Override
		...
		Color yellow = new Color(255, 233, 55); // Yellow color
		Color green = new Color(76, 187, 23); // Green color
		cell1.setBackground(green);
		cell2.setBackground(yellow);
		cell3.setBackground(green);
		cell4.setBackground(yellow);
		cell5.setBackground(green);
		cell6.setBackground(yellow);
		cell7.setBackground(green);
		cell8.setBackground(yellow);
		cell9.setBackground(green);
		...
		ActionListener e = (ActionListener) new ActionListener()// oh lord
		{
			...
			public void actionPerformed(ActionEvent e) // button press stuff
			{
				...
				if (gamemode == "AI") // For AI Mode
				{
					...
					{
						int x[] = bestMove(kandc, board, moves, isX, ally, opponent);
	...
	// AI Stuff Start
	public static int checkWinnerConverted(KnotsAndCrosses kandc, String[][] board, boolean isX, String ally,
			String opponent) {
		int winScore = 0;
	...
	public static int AI(KnotsAndCrosses kandc, String[][] board, boolean maximizer, int moves, boolean isX,
			String ally, String opponent) {
	...
	public static int[] bestMove(KnotsAndCrosses kandc, String[][] board, int moves, boolean isX, String ally,
			String opponent) {
		if (isX == true) {
			ally = "O";
			opponent = "X";
